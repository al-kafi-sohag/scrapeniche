<div class="container" style="margin-top: -310px;">
    <div class="row">
        <div class="col-xl-7 ms-xl-auto">
            <div class="about-services-wrapper">
                <div class="mb-0 owl-carousel owl-theme custom-carousel-box-shadow-1 custom-dots-style-1"
    ...
    <div id="aboutus" class="pt-4 mt-5 row align-items-xl-center">
        <div class="mb-5 col-md-10 col-lg-6 mb-lg-0">
            <div class="row row-gutter-sm">
                <div class="col-6">
                    <img src="{{ asset('frontend/img/demos/business-consulting-3/generic/generic-1.jpg') }}"
                        class="img-fluid box-shadow-5" alt="Data Analytics Dashboard" />
                </div>
                <div class="col-6">
                    <img src="{{ asset('frontend/img/demos/business-consulting-3/generic/generic-2.jpg') }}"
                        class="mb-4 img-fluid box-shadow-5" alt="Web Scraping Process" />
                    <img src="{{ asset('frontend/img/demos/business-consulting-3/generic/generic-3.jpg') }}"
                        class="img-fluid box-shadow-5" alt="Data Visualization" />
                </div>
            </div>
        </div>
            ...
            <div class="pb-2 mb-4 row align-items-center mb-lg-1 mb-xl-4 appear-animation"
                ...
                <div class="col-6">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-code text-color-primary text-8"></i>
                        <span class="pt-2 text-3 font-weight-bold text-color-dark ms-3">
                            <strong class="mb-2 d-block font-weight-bold text-9">100%</strong>
                            Custom Solutions
                        </span>
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-shield-alt text-color-primary text-8"></i>
                        <span class="pt-2 text-3 font-weight-bold text-color-dark ms-3">
                            <strong class="mb-2 d-block font-weight-bold text-9">24/7</strong>
                            Data Security
                        </span>
                    </div>
                </div>
