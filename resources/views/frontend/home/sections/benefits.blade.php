<section class="m-0 border-0 section section-height-4 section-with-shape-divider position-relative bg-dark">
    ...
    <div class="top-0 left-0 position-absolute h-100 d-none d-lg-block overlay overlay-show overlay-color-primary"
        data-plugin-parallax data-plugin-options="{'speed': 1.5}"
        data-image-src="{{ asset('frontend/img/demos/business-consulting-3/parallax/parallax-corporate-21-1.jpg') }}"
        style="width: 40%;"></div>
    <div class="container pt-5 mt-5 position-relative z-index-3">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2 class="clearfix mb-0 custom-text-background custom-big-font-size-1 text-15 font-weight-bold float-end line-height-1 lazyload pe-xl-5 me-3 d-none d-lg-block"
                    data-bg-src="{{ asset('frontend/img/demos/business-consulting-3/backgrounds/text-background-2.jpg') }}"
